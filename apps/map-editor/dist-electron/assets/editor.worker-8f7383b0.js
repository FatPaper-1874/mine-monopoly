(function() {
  ...
  class Emitter {
    constructor(options) {
      ...
      this._leakageMon = ((_a3 = this._options) == null ? void 0 : _a3.leakWarningThreshold) ? new LeakageMonitor((options == null ? void 0 : options.onListenerError) ?? onUnexpectedError, ((_b3 = this._options) == null ? void 0 : _b3.leakWarningThreshold) ?? _globalLeakWarningThreshold) : void 0;
  ...
  const _BaseEditorSimpleWorker = class {
    constructor() {
